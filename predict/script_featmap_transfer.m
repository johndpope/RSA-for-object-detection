...
param.gpu_id = 1;
%param.init_model = fullfile(pwd, 'output/ResNet-101L/700000');
param.init_model = fullfile(pwd, 'output/ResNet_3b_s16_fm2fm_pool2_deep/65w'); %fullfile(pwd, 'output/ResNet-101L/1000000');
